...
insert into material (cod_mat, descricao, preco_unt) values
    (seq_cod_mat.NEXTVAL, 'SMART TV 40', 2200.00);
insert into material (cod_mat, descricao, preco_unt) values
    (seq_cod_mat.NEXTVAL, 'SMARTPHONE', 1999.99);
insert into material (cod_mat, descricao, preco_unt) values
